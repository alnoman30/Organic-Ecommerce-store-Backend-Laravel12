                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{route('home')}}" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="{{ asset('images/logo/logo.svg') }}"
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.all-blog-categories')}}" class="">
                                                <div class="text">All Categories</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.add-blog-categories')}}" class="">
                                                <div class="text">New Blog Category</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.add-blogs')}}" class="">
                ...
                <div class="section-content-right">
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="{{route('home')}}">
                                    <img class="" id="logo_header_mobile" alt="" src="images/logo/logo.svg"
                                        data-light="images/logo/logo.svg" data-dark="images/logo/logo.svg"
                                        data-width="154px" data-height="52px" data-retina="images/logo/logo.svg">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                    ...
                    @yield('content')
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2025 Organic - Grocery Store</div>
                        </div>
                    </div>
                    </div>
