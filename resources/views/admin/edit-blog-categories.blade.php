...
@section('content')
                            ...
                            <div class="main-content-wrap">
                                ...
                                <!-- new-category -->
                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" action="{{ route('admin.blog-category.update', $category->id)}}" method="POST"
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Category Slug" name="slug"
                                                tabindex="0" value="{{ old('name', $category->slug) }}" aria-required="true" required="">
                                        </fieldset>
                                        <div class="bot">
                                            <div></div>
